...
const DeleteProjectIdea = ({
  ...
  const confirmDelete = async () => {
    ...
    await axios
      .post(process.env.REACT_APP_API_URL + "/api/deleteProjectIdea", {
        userId,
        projectId,
      },
      {
    ...
    <div className="delete-task-wrapper">
      <div className="pp-popup-wrapper">
        ...
        <div className="row mt-3 d-flex ">
          <p className="d-flex justify-content-center">Delete Project Idea </p>
          <p className="d-flex justify-content-center">
            {" "}
            Are you sure you want to delete the project idea?
          </p>
        </div>
...
export default DeleteProjectIdea
