...
const ProjectModalEdit = ({projectName,projectDescriptions,indexNumber,projectTechnology,projectLinks,hostedLinks,memberName}) => {
    ...
    const handleSubmit = (e) => {
        ...
        if (error) {
            ...
            axios
                .post(process.env.REACT_APP_API_URL + "/api/v3/editProject", {
                    projectId,
                    projName,
                    description,
                    projectLink,
