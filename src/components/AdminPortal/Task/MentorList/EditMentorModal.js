...
const EditMentorModal = ({
  ...
  selectedMentorName,
  selectedMentorEmail,
  selectedMentorDesignation,
  selectedMentorTechTags,
  selectedMentorImage,
  selectedMentorChecked,
  selectedMentorPermissions
}) => {
  ...
  const handleClickClear = () => {
    onHide();
    setMentorName(selectedMentorName);
    setEmail(selectedMentorEmail);
    setDesignation(selectedMentorDesignation);
    setImageUrl(selectedMentorImage);
    setTechnologyNames(selectedMentorTechTags);
    setPermissions(selectedMentorPermissions);
    // setIsCleared(true);
    setIsChecked(selectedMentorChecked);
    setCurrentPage(1);
    // setTech({});
              ...
              <div className="mt-3">
                <div className="form-check">
                  <input
                    ...
                    type="checkbox"
                    id="checkbox1"
                    checked={permissions.includes("Session")}
                    onChange={(e) => {
                      handlePermissionsChange(e, "Session");
                    }}
                    disabled={!isChecked}
                  />
                  <label
                ...
                <div className="form-check mt-2">
                  <input
                    ...
                    type="checkbox"
                    id="checkbox2"
                    checked={permissions.includes("Project")}
                    onChange={(e) => {
                      handlePermissionsChange(e, "Project");
                    }}
                    disabled={!isChecked}
                  />
                  <label
                ...
                <div className="form-check mt-2">
                  <input
                    ...
                    onChange={(e) => {
                      handlePermissionsChange(e, "Review");
                    }}
                    disabled={!isChecked}
                  />
                  <label
                ...
                <div className="form-check mt-2">
                  <input
                    ...
                    type="checkbox"
                    id="checkbox4"
                    checked={permissions.includes("Know Your Mentor")}
                    onChange={(e) => {
                      handlePermissionsChange(e, "Know Your Mentor");
                    }}
                    disabled={!isChecked}
                  />
                  <label
