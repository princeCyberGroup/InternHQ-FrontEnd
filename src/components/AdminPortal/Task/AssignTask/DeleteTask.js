...
const TaskDeleted = ({ taskId, onDelete }) => {
  const [isLoading, setIsLoading] = useState(false);
  ...
  const deleteTask = () => {
    ...
    onDelete(true);
    // axios
    //   .post("https://cg-interns-hq.azurewebsites.net/deleteTask", { taskId })
    //   .then((res) => {
  ...
  const cancelDeletion = () => {
    onDelete(false); // Send 'false' to parent component indicating cancellation
  };
