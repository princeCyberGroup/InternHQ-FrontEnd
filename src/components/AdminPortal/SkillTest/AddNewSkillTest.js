import { ReactComponent as CloudImage } from "../Dashboard/Assets/Cloud.svg";
// import FileUploadButton from "./DragandDropFile";
import CSVReader from "../Dashboard/UploadCsv/DragandDropFile.js";
import { ReactComponent as DropDown } from "../Dashboard/Assets/dropdown.svg";
...
export const AddNewSkillTest = () => {
    ...
    return (
        <div>
            <button style={{display:"none"}} type="button" className="btn" data-bs-toggle="modal" data-bs-target="#newSkillModal">Add New Skill Test</button>
