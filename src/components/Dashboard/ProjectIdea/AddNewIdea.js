          ...
          <div className="card">
              ...
              {/* <div className="row"> */}
                ...
                <div className="col-6">
                  <button className="w-100">
                    Project <AddNewProjectComponent />
                  </button>
                </div>
              {/* </div> */}
            </div>
            ...
            <div className="row">
              <p className="paragraph">
                Simply share your project ideas with us, and our experts will
                review it and provide feedback and guidance on how to take it to
                the next level.
                <br />
              </p>
            </div>
            ...
            <div class="d-flex justify-content-between">
              <div class="d-flex">
                <p class="text mb-0 ms-1">
                  <b>Shared Project Idea</b>
                </p>
              </div>
            ...
            <div className="row">
              <div className="third-div">
                ...
                <p>
                  The Recipe Recommendation Engine is a web-based application
                  that uses machine learning algorithm...
                  <br />
                </p>
